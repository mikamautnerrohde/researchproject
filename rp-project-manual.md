...
[Internal assessor](#internal-assessor-tasks) | <ul><li>Is located in same lab/research group as supervisor. <li>Holds a doctoral degree. <li>Can be same person as daily supervisor, as long requirements for both roles are met.</ul>|<ul><li>Monitors student performance in correspondence with supervisor.<li>Joins the midterm evaluation</li><li>Grades experimental work, presentation and final report.<li>Joins the final feedback meeting</ul>
